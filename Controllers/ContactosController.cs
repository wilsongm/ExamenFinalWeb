...
namespace ExamenFinalWeb.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdContacto,NombreC,Apellido,Identificacion")] Contactos contactos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdContacto,NombreC,Apellido,Identificacion")] Contactos contactos)
        {
            if (ModelState.IsValid)
            {
